...
be decided by the master and carried in `RunFault`. An endpoint receiving a fault frame it does
not handle SHALL log it and continue the session rather than terminating.
